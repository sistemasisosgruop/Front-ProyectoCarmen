  ...
  return (
    <>
      <tr className="text-sm">
        <td>{index + 1}</td>
        <td className="whitespace-nowrap px-4 py-2">{department.roomType}</td>
        <td className="whitespace-nowrap px-4 py-2">{department.description}</td>
        <td className="whitespace-nowrap px-4 py-2">{department.address}</td>
        <td className="whitespace-nowrap px-4 py-2">S/. {department.price}</td>
        <td className="whitespace-nowrap px-4 py-2">
          {checkIn} - {checkOut}
        </td>
        <td className="whitespace-nowrap px-4 py-2">{department.numBathrooms}</td>
        <td className="whitespace-nowrap px-4 py-2">{department.numBeds}</td>
        <td className="whitespace-nowrap px-4 py-2">
          <div className="flex justify-center items-center gap-4">
            <span>{department.numBeds}</span>
            <button type="button" onClick={() => handleBedDetails(index)} className="p-1 text-dark">
              <BiChevronDown size={24} />
            </button>
          </div>
        </td>
        <td className="whitespace-nowrap px-4 py-2">{department.extras?.join(', ') + '.'}</td>
        <td className="whitespace-nowrap px-4 py-2">
        ...
        <td className="whitespace-nowrap px-4 py-2">
          {department.roomImages.length === 0 && (
