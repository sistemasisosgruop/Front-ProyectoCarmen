            ...
            <tbody>
              {[...Array(5)].map((_, index) => (
                <tr key={index} className="text-sm">
                  ...
                  <td className="whitespace-nowrap px-4 py-2">2</td>
                  <td className="whitespace-nowrap px-4 py-2">0</td>
                  <td className="whitespace-nowrap px-4 py-2">VIVA AIR</td>
                  <td className="whitespace-nowrap px-4 py-2">20/04/2023</td>
                  <td className="whitespace-nowrap px-4 py-2">-</td>
                  <td className="whitespace-nowrap px-4 py-2">Directo</td>
                  <td className="whitespace-nowrap px-4 py-2">-</td>
                  <td className="whitespace-nowrap px-4 py-2">
                    <button type="button" className="p-1 text-dark">
