        ...
        <TabItem label='Incluye' icon={<BsCheckCircle />}>
          <div className='mb-8'>
            ...
            <ul>
              ...
              <li>
                Ticket de ingreso boleto tur&iacute;stico
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul>
              <li>
                Ingreso/entrada: Valle Sagrado de los Incas
              </li>
            </ul>
          </div>
        </TabItem>
        <TabItem label='Itinerario' icon={<BsCardChecklist />}>
          <div className='mb-4'>
            ...
            <p className='text-dark'>
              Explora las ruinas Incas de Ollantaytambo, Pisac y mucho m&aacute;s. Salidas diarias para personas solas y grupos de todas las edades y el viaje es en bus tur&iacute;stico.
            </p>
          </div>
          <ul className='text-dark'>
            <li>
              08:30 - 09:00 Recojo de su hotel y traslado en bus tur&iacute;stico.
            </li>
            <li>
              08:30 - 09:00 Recojo de su hotel y traslado en bus tur&iacute;stico.
            </li>
        ...
        <TabItem label='Salida y regreso' icon={<TbPaperBag />}>
          <div className='mb-4'>
            ...
            <ul className='list-disc list-inside ml-4 text-dark'>
              <li>
                Inticahuary 617, Cusco 08002, Per&uacute; a espaldas del templo de Koricancha.
              </li>
            </ul>
          </div>
          <div className='mb-4'>
