  ...
  return (
    <div className='relative w-full group/description cursor-pointer transition-all overflow-hidden'>
      <img
        src={imagePath}
        alt={alt}
        className='relative h-[380px] object-cover object-center border border-white rounded-md group-hover/description:scale-125 duration-200'
      />
      <div className='invisible absolute top-2 right-2 bg-white px-2 py-1 rounded-md group-hover/description:visible'>
