  ...
  return (
    <article className="flex justify-between items-center gap-4">
      ...
      <div className="w-full sm:flex sm:justify-start">
        <img
          src={product?.roomImages?.imageUrl}
          alt="imagen producto"
        ...
        <div className="w-full p-2 sm:px-4">
          <article className="flex justify-between items-center gap-4">
            <div>
              <h3 className="text-dark text-lg font-bold">{product.roomType}</h3>
              <p className="text-base text-gray-600">10 diciembre - 14 diciembre</p>
            </div>

            <p className="flex flex-col">
              {/* <span className="text-gray-600 text-center text-xs">S/. {product.price?.toLocaleString(undefined, { minimumFractionDigits: 2 })} / 4 días</span> */}
              <span className="text-xl text-blue text-center font-bold whitespace-nowrap">
                S/. {product.price?.toLocaleString(undefined, { minimumFractionDigits: 2 })}
              </span>
            </p>
          </article>
